  ...
  return (
    <div className="mx-auto px-4 py-10 md:px-20 md:py-20">
      ...
      <div className="flex flex-col md:flex-row justify-center items-center space-y-4 md:space-y-0 md:space-x-4">
        <Card className={`${cardBg} transition duration-300 ease-in-out transform hover:scale-105 hover:shadow-2xl flex flex-col items-center justify-center w-full md:w-[335px] h-[300px] text-center`}>
